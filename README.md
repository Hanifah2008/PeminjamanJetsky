...
<body>
    ...
    <video autoplay muted loop playsinline class="bg-video">
        <source src="http://127.0.0.1:8000/video/bg.mp4" type="video/mp4">
        <source src="http://127.0.0.1:8000/video/bg.mp4" type="video/mp4">
    </video>

    <!-- AUDIO BACKGROUND -->
    <audio id="bgAudio" loop style="display: none">
        <source src="http://127.0.0.1:8000/audio/background-music.mp3" type="audio/mpeg">
    </audio>
        ...
        <div class="container">
            <div class="navbar">
                ...
                <div class="nav-links">
                    ...
                    <a href="http://127.0.0.1:8000/login" class="btn-outline" style="background: linear-gradient(135deg, #00d4ff, #0099cc); color: white; border: none;"><i class="fas fa-user-tie"></i> Admin</a>
                    <a href="http://127.0.0.1:8000/petugas/login" class="btn-outline" style="background: linear-gradient(135deg, #00d4ff, #0099cc); color: white; border: none;"><i class="fas fa-user-check"></i> Petugas</a>
                    <a href="http://127.0.0.1:8000/customer/login" class="btn-outline" style="background: linear-gradient(135deg, #00d4ff, #0099cc); color: white; border: none;"><i class="fas fa-user"></i> Customer</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <main>
        ...
        <div class="container" id="home">
            <div class="hero">
                ...
                <div class="hero-media">
                    <img src="http://127.0.0.1:8000/video/jetskiy.jpg" alt="Jetski Action">
                </div>
            </div>
        </div>
     ...
     src="http://127.0.0.1:8000/uploads/images/1775438212_Drone Follows Miami Jetski Daniela Diaz 4k(Miami Drone Services).mp4" 
     alt="Sky Camera Pro 4K">
            
            <div class="card-content">
                <h3>Sky Camera Pro 4K</h3>
                <p>Promo Sky! Diskon 15% untuk semua Sky Camera</p>
                
                <div class="specs">
                    <span><i class="fas fa-tachometer-alt"></i> 230 HP</span>
                    <span><i class="fas fa-box"></i> Stok: 10</span>
                </div>

                <div class="price-tag">Rp150.000/jam</div>
                
                                    <small style="color:#ff7f7f;">*Diskon 15% tersedia!</small>
                            </div>
        </div>
                <div class="jetski-card">
            <img class="jetski-img" 
     src="http://127.0.0.1:8000/uploads/images/1775438446_jetskistx160 crystal.jpg" 
     alt="Kawasaki-Jet-Ski-STX-160-2024">
            
            <div class="card-content">
                <h3>Kawasaki-Jet-Ski-STX-160-2024</h3>
                <p>Promo Sky! Diskon 15% untuk semua Sky Camera</p>
                
                <div class="specs">
                    <span><i class="fas fa-tachometer-alt"></i> 230 HP</span>
                    <span><i class="fas fa-box"></i> Stok: 15</span>
                </div>

                <div class="price-tag">Rp200.000/jam</div>
                ...
                <div class="jetski-card">
            <img class="jetski-img" 
     src="http://127.0.0.1:8000/uploads/images/1775438622_kawasakiJetSkiUltra310.jpg" 
     alt="JET SKI ULTRA 310LX">
            
            <div class="card-content">
                <h3>JET SKI ULTRA 310LX</h3>
                <p>Promo Drone! Diskon 20% untuk semua Drone</p>
                ...
                <div class="price-tag">Rp200.000/jam</div>
                                    ...
                                    <small style="color:#ff7f7f;">*Diskon 20% tersedia!</small>
                            </div>
        </div>
                <div class="jetski-card">
            <img class="jetski-img" 
     src="http://127.0.0.1:8000/uploads/images/1775438812_jetski pink.jpg" 
     alt="seadoo jet-ski kliff graphic kit pink">
            
            <div class="card-content">
                <h3>seadoo jet-ski kliff graphic kit pink</h3>
                <p>Promo Drone! Diskon 20% untuk semua Drone</p>
                
                <div class="specs">
                    <span><i class="fas fa-tachometer-alt"></i> 230 HP</span>
                    <span><i class="fas fa-box"></i> Stok: 4</span>
                </div>

                <div class="price-tag">Rp250.000/jam</div>
                ...
                <div class="jetski-card">
            <img class="jetski-img" 
     src="http://127.0.0.1:8000/uploads/images/1775448163_dronmahal.jpg" 
     alt="DJI Mini 5 Pro">
            ...
            <div class="card-content">
                ...
                <div class="specs">
                    <span><i class="fas fa-tachometer-alt"></i> 230 HP</span>
                    <span><i class="fas fa-box"></i> Stok: 3</span>
                </div>

                <div class="price-tag">Rp135.000/jam</div>
                ...
                <div class="jetski-card">
            <img class="jetski-img" 
     src="http://127.0.0.1:8000/uploads/images/1775439296_PELAMPUNG.avif" 
     alt="swim vest">
            
            <div class="card-content">
                <h3>swim vest</h3>
                <p>Unit mewah dengan kondisi prima, stabil dan nyaman untuk digunakan.</p>
                
                <div class="specs">
                    <span><i class="fas fa-tachometer-alt"></i> 230 HP</span>
                    <span><i class="fas fa-box"></i> Stok: 25</span>
                </div>

                <div class="price-tag">Rp50.000/jam</div>
                ...
                <div class="jetski-card">
            <img class="jetski-img" 
     src="http://127.0.0.1:8000/uploads/images/1775453139_jet merah.jpg" 
     alt="Jet Ski Stroke Rxt-X 325">
            
            <div class="card-content">
                <h3>Jet Ski Stroke Rxt-X 325</h3>
                <p>Unit mewah dengan kondisi prima, stabil dan nyaman untuk digunakan.</p>
                
                <div class="specs">
                    <span><i class="fas fa-tachometer-alt"></i> 230 HP</span>
                    <span><i class="fas fa-box"></i> Stok: 2</span>
                </div>
                ...
                <div class="jetski-card">
            <img class="jetski-img" 
     src="http://127.0.0.1:8000/uploads/images/1775454025_helem keselamatan.jpg" 
     alt="helem keselamatan">
            
            <div class="card-content">
                <h3>helem keselamatan</h3>
                <p>Unit mewah dengan kondisi prima, stabil dan nyaman untuk digunakan.</p>
                
                <div class="specs">
                    <span><i class="fas fa-tachometer-alt"></i> 230 HP</span>
                    <span><i class="fas fa-box"></i> Stok: 20</span>
                </div>

                <div class="price-tag">Rp35.000/jam</div>
