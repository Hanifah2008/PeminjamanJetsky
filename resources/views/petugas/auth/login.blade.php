...
<head>
    ...
    <title>Login Petugas - Hani Jestky Jogja</title>
    ...
    <div class="login-box">
        <div class="card card-outline">
            ...
            <div class="card-body">
                ...
                <form action="/petugas/login/do" method="post">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                               placeholder="Email Petugas" name="email" value="{{ old('email') }}" required autofocus>
